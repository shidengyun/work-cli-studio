...
import enVerificationCodes from "./en/verification-codes.json";
...
import zhHansVerificationCodes from "./zh-Hans/verification-codes.json";
...
import koVerificationCodes from "./ko/verification-codes.json";
...
import jaVerificationCodes from "./ja/verification-codes.json";
...
export const RESOURCES: Record<SupportedLocale, LocaleResources> = {
  en: {
    ...
    squads: enSquads,
    billing: enBilling,
    "verification-codes": enVerificationCodes,
  },
  "zh-Hans": {
    common: zhHansCommon,
    auth: zhHansAuth,
    ...
    "verification-codes": zhHansVerificationCodes,
  },
  ko: {
    common: koCommon,
    auth: koAuth,
    ...
    squads: koSquads,
    billing: koBilling,
    "verification-codes": koVerificationCodes,
  },
  ja: {
    common: jaCommon,
    auth: jaAuth,
    ...
    squads: jaSquads,
    billing: jaBilling,
    "verification-codes": jaVerificationCodes,
  },
};
